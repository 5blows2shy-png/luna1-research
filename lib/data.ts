...
export const navigationItems: NavigationItem[] = [
  ...
  { label: "Luna1 Framework", href: "/luna1-framework" }, { label: "Research", href: "/research" },
...
export const research: ResearchReport[] = [
  ["ANET","Arista Networks","Network Infrastructure","AI infrastructure",92,"Prism Superleader","AI cluster networking demand","Customer concentration","2026-06-28","Monitoring"],
  ["STRL","Sterling Infrastructure","Engineering & Construction","Data centers",87,"Luna1-A","Mission-critical project backlog","Project execution","2026-06-19","Active"],
  ["PDFS","PDF Solutions","Semiconductor Software","Yield analytics",81,"Luna1-A","Analytics adoption","Revenue variability","2026-06-08","Watchlist"],
  ["CASY","Casey’s General Stores","Consumer Staples","Store density",84,"Luna1-A","Private-label expansion","Food inflation","2026-05-30","Active"],
  ["TD","Toronto-Dominion Bank","Banks","Recovery",73,"Luna1-B","Expense normalization","Regulatory limits","2026-05-18","Monitoring"],
  ["PANW","Palo Alto Networks","Cybersecurity","Platformization",89,"Luna1-A","Next-gen security ARR","Billings transition","2026-05-04","Active"],
  ["ADPT","Adaptive Biotechnologies","Biotechnology","Immune medicine",67,"Watchlist","MRD adoption","Cash burn","2026-04-23","Watchlist"],
  ["MRCY","Mercury Systems","Aerospace & Defense","Defense electronics",76,"Luna1-B","Program recovery","Execution history","2026-04-10","Monitoring"],
  ["JBL","Jabil","Electronic Manufacturing","AI hardware",82,"Luna1-A","Cloud hardware mix","Cyclical end markets","2026-03-27","Active"],
  ["AVGO","Broadcom","Semiconductors","AI infrastructure",94,"Prism Superleader","Custom silicon demand","Valuation compression","2026-03-12","Active"],
