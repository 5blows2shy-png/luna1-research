...
test("required routes and disclaimer exist",()=>{for(const path of routes)assert.ok(fs.existsSync(path),path);assert.match(fs.readFileSync("src/components/site.tsx","utf8"),/Nothing on this website constitutes investment advice/)});
