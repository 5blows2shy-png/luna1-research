...
const roles = [
  ...
  { date: "Nov 2020–Present", company: "LightEdge Solutions", title: "Data Center Network Operations Technician", bullets: [
  ...
  return <>
    ...
    <section className="resume-layout">
      <aside>
        ...
        <span className="eyebrow">Certifications</span><p>QuickBooks Online Level 1<br/>Bloomberg Market Concepts<br/>SIE · Planned</p>
        <span className="eyebrow">Skills</span><p>Fundamental equity research, financial modeling, valuation, reconciliation, reporting, portfolio analysis, and mission-critical operations.</p>
      </aside>
