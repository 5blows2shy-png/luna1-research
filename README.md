...
- `app/` - App Router pages and the demonstration contact endpoint
- `components/` - shared navigation, footer, score, form, and calculators
- `lib/data.ts` - typed navigation, research, and commentary content
