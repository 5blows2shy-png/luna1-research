...
roles = [
    ("Coronado Historical Association", "Executive & Finance Assistant", "May 2026 - Present", "Support accrual accounting, reconciliations, financial reporting schedules, board materials, and audit-ready nonprofit finance documentation."),
    ("LightEdge Solutions", "Data Center Network Operations Technician", "Nov 2020 - Present", "Support mission-critical infrastructure, customer operations, asset controls, service coordination, and compliance records across network and facility systems."),
...
def header():
    table = Table([[Paragraph("SHY LEE", styles["Name"]), Paragraph("FINANCE / EQUITY RESEARCH<br/>Professional inquiries: luna1-research.vercel.app/contact", styles["Date"])]], colWidths=[4.3*inch, 2.9*inch])
...
def make_resume():
    ...
    story = [header(), Paragraph("PROFESSIONAL SUMMARY", styles["Section"]), Paragraph("U.S. Army veteran and finance professional combining equity research, accounting, financial analysis, and more than five years inside mission-critical data center operations. Applies disciplined research to company fundamentals, valuation, industry structure, capital allocation, and risk.", styles["BodySmall"]), Paragraph("PROFESSIONAL EXPERIENCE", styles["Section"])]
    ...
    story += [Paragraph("EDUCATION", styles["Section"]), Paragraph("<b>San Diego State University, Fowler College of Business</b> - B.S. Finance, expected 2027<br/><b>San Diego Miramar College</b> - A.S. Business Administration, 2024", styles["BodySmall"]), Paragraph("RESEARCH & LEADERSHIP", styles["Section"]), Paragraph("<b>Aztec Investment Fund</b> - Fundamental equity research, thesis development, and AI infrastructure value-chain analysis informed by hands-on data center experience.", styles["BodySmall"]), Paragraph("CERTIFICATIONS & SKILLS", styles["Section"]), Paragraph("QuickBooks Online Level 1; Bloomberg Market Concepts; Microsoft Excel (in progress); SIE and FMVA (planned).<br/>Fundamental research, financial modeling, valuation, reporting, reconciliation, portfolio analysis, QuickBooks Online, Excel, Python workflows, and mission-critical operations.", styles["BodySmall"])]
    doc.build(story)
...
def make_profile():
    ...
    story = [header(), Spacer(1, 10), body, Spacer(1, 14), Paragraph("SELECTED PROOF OF WORK", styles["Section"]), Paragraph("Featured company research / transparent financial models / documented portfolio methodology / mistake-journal process / print-friendly recruiter portal", styles["BodySmall"]), Spacer(1, 12), Paragraph("Explore the full profile and contact Shy at luna1-research.vercel.app/recruiter", styles["Deck"])]
    doc.build(story)
