...
def make_profile():
    ...
    story = [header(), Spacer(1, 10), body, Spacer(1, 14), Paragraph("SELECTED PROOF OF WORK", styles["Section"]), Paragraph("Featured company research / transparent financial models / documented portfolio methodology / mistake-journal process / print-friendly recruiter portal", styles["BodySmall"]), Spacer(1, 12), Paragraph(f"Explore the full profile and contact Shy at {SITE}/recruiter", styles["Deck"])]
    doc.build(story)
