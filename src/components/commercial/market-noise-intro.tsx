...
export function MarketNoiseIntro({ active }: { active: boolean }) {
  return <div className="commercial-scene market-noise" aria-hidden={!active}>
    ...
    <div className="scene-copy"><span>01 / Signal environment</span><h2>Markets create noise.</h2><p>Illustrative market data — not real time</p></div>
  </div>;
}
