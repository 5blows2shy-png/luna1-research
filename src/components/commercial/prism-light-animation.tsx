...
const dimensions = ["Fundamentals", "Technical Analysis", "Risk", "Valuation", "Psychology", "Process", "Discipline", "Capital Allocation"];
...
export function PrismLightAnimation({ active }: { active: boolean }) {
  return <div className="commercial-scene prism-scene" aria-hidden={!active}>
    <svg viewBox="0 0 1200 600" role="presentation">
      ...
      {dimensions.map((label, index) => { const y = 150 + index * 48; const colors = ["#68aadd", "#707fc1", "#8274bd", "#9c70ad", "#b56f96", "#c8777d", "#d48363", "#d99a55"]; return <g key={label}>
