...
function TickerItem({ quote, onSelect }: { quote: MarketQuote; onSelect: () => void }) {
  ...
  return <button className={`portfolio-quote ${change.direction}`} onClick={onSelect} aria-label={`${quote.symbol}, ${portfolioBucketBySymbol[quote.symbol]}, ${dataTypeLabels[quote.dataType]}`}>
