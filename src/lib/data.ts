...
export const research: ResearchReport[] = [
  ...
  [
    ...
    87,
    "LUNA-A",
    "Mission-critical project backlog",
    "Project execution",
    "2026-06-19",
    "Active",
  ],
...
export const commentary = [
  {
    slug: "breadth-beneath-index",
    category: "Market Breadth",
    date: "July 8, 2026",
    title: "Reading the breadth beneath the index",
    summary:
      "Leadership is broadening selectively, but participation remains concentrated in companies with visible estimate revisions.",
  },
  {
    slug: "rotation-quality-cyclicals",
    category: "Sector Rotation",
    date: "June 26, 2026",
    title: "Rotation toward quality cyclicals",
    summary:
      "Capital is moving toward operators with backlog visibility, pricing power, and improving free-cash-flow conversion.",
  },
  {
    slug: "rates-duration",
    category: "Interest Rates",
    date: "June 13, 2026",
    title: "Rates, duration, and the burden of proof",
    summary:
      "Higher discount rates raise the evidence threshold for long-duration growth, making operating leverage more consequential.",
  },
];
