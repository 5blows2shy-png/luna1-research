...
export const metadata:Metadata={metadataBase:new URL("https://luna1-research.vercel.app"),title:{default:"Luna1 Research",template:"%s | Luna1 Research"},description:"Institutional-quality independent investment research by Shyheim Lee.",authors:[{name:"Shyheim Lee",url:"https://www.linkedin.com/in/shyheim-lee/"}],openGraph:{title:"Luna1 Research",description:"Business fundamentals, valuation, institutional sponsorship, and technical structure.",images:["/brand/luna1-social-card.png"]},twitter:{card:"summary_large_image",title:"Luna1 Research",description:"Independent investment research by Shyheim Lee.",images:["/brand/luna1-social-card.png"]}};
