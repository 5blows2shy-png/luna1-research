...
export const viewport:Viewport={width:"device-width",initialScale:1,colorScheme:"dark light",themeColor:[{media:"(prefers-color-scheme: dark)",color:"#090c0d"},{media:"(prefers-color-scheme: light)",color:"#f4f0e8"}]};
