...
export default function Luna(){return <>
  <PageHeader kicker="Layered Understanding of Narrative Acceleration" title="The Klyro Framework" description="The Klyro Framework is Klyro's proprietary multi-factor investment research methodology designed to identify companies experiencing accelerating business fundamentals, improving institutional sponsorship, expanding competitive advantages, and constructive Stage 2 technical structure."/>
  <section className="luna-brand"><span className="eyebrow">Klyro · Investment Research Framework</span><h2>Separating price into the business fundamentals that create it.</h2><p>Layered Understanding of Narrative Acceleration</p><div className="factor-list">{factors.map((factor,i)=><div key={factor}><span>{String(i+1).padStart(2,"0")}</span><b>{factor}</b></div>)}</div><p className="factor-note">These nine factors combine into a proprietary Klyro Score ranging from 0 to 100.</p></section>
  ...
  <section><SectionHeading eyebrow="Interactive demo" title="Build a Klyro Score." copy="Adjust the sample inputs to see how the 100-point classification responds. This is illustrative data, not a security rating."/><Scorecard/><div className="classification"><div><b>90–100</b><span>Klyro Superleader</span></div><div><b>80–89</b><span>Klyro-A</span></div><div><b>70–79</b><span>Klyro-B / Inflection Leader</span></div><div><b>60–69</b><span>Watchlist</span></div><div><b>&lt;60</b><span>Does Not Qualify</span></div></div></section>
  </>}
