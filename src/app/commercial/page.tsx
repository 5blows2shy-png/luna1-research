...
export default function CommercialPage() { return <>
  <section className="commercial-header"><span className="eyebrow">Luna1 Research · Brand film</span><h1>From market noise<br/>to research clarity.</h1><p>A 25-second portrait of an independent research process built around discipline, evidence, and continuous improvement.</p></section>
